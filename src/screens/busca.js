            ...
            try {
                ...
                const livrosArray = snapshot.docs.map(docData => {
                    ...
                    return {
                        ...
                        blocos: Array.isArray(data.contexto_historico?.blocos) ? data.contexto_historico.blocos : [],
                        titulos: Array.isArray(data.contexto_historico?.titulos) ? data.contexto_historico.titulos : [],
